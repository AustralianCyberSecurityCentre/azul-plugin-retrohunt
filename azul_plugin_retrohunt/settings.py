...
class RetrohuntSettings(BaseSettings):
    ...
    class SearhSettings(BaseSettings):
        ...
        max_required_strings_per_and_search: int = Field(4, alias="MAX_REQUIRED_STRINGS_PER_AND_SEARCH")
        ...
        max_narrow_phase_inflight_files: int = Field(10, alias="MAX_NARROW_PHASE_INFLIGHT_FILES")
    ...
    class RedisSettings(BaseSettings):
        ...
        ttl: int = Field(30, alias="REDIS_TTL")
